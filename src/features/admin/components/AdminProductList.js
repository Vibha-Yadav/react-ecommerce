          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
            ...
            <div>
                ...
                to="/admin/product-form"
                 className="rounded-md mx-10 my-5 bg-green-600 mb-2 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    Add New Product
                </Link>
            </div>
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-700">
            Showing <span className="font-medium">{(page-1)*ITEMS_PER_PAGE+1}
        ...
        <div>
          <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            ...
            {Array.from({length:totalPages}).map(
              ...
              aria-current="page"
              className={`relative cursor-pointer z-10 inline-flex items-center ${index+1===page? 'bg-indigo-600 text-white':'text-gray-400'}  px-4 py-2 text-sm
      ...
      <div className="mx-auto max-w-2xl px-4 py-0 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8">
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
          ...
          <div>  
            ...
            <div  className="group relative border-solid border-2 p-2 border-gray-200">
              ...
              <div className="mt-4 flex justify-between">
                <div>
                  ...
                  <StarIcon className="h-5 w-5 inline text-yellow-400" aria-hidden="true" />
            ...
            <div>
                <button className="rounded-md my-5 bg-indigo-600 mb-2 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    Edit Product
                </button>
            </div>
          </div>  
